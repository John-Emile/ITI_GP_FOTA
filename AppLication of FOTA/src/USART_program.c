...
#include "../include/MCAL/UART/MAURT_private.h"
...
void MUART_Recieve(u8* u8DataCPY)
{
...
{
	u8 u8statuesLOCAL=1; // a variable to check if there is anything received by UART or not//
