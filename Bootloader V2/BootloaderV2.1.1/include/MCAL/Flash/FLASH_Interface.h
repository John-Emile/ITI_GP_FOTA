...
typedef enum
{
	FLASH_SECTOR_ZERO_OFFSET  =	0x08000000,
	FLASH_SECTOR_ONE_OFFSET   =	0x08004000,
	FLASH_SECTOR_TWO_OFFSET   = 0x08008000,
	FLASH_SECTOR_THREE_OFFSET = 0x0800C000,
	FLASH_SECTOR_FOUR_OFFSET  = 0x08010000,
	FLASH_SECTOR_FIVE_OFFSET  = 0x08020000,
	FLASH_SECTOR_SIX_OFFSET   = 0x08040000,
	FLASH_SECTOR_SEVEN_OFFSET = 0x08060000,
